...
### Setup
- In order to get a copy of this project you need to download it from https://github.com/Profsain/hello-rails-react-backend
...
Feel free to check the [issues page](https://github.com/Profsain/hello-rails-react-backend/issues/).
